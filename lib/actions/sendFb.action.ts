...
export async function sendFacebookLeadEvent() {
  ...
  if (!accessToken || !pixelId) {
    return { error: "Missing required cookies (token or fbpixel)" };
  }
  ...
  // In Next.js, we'll need to pass these from the client side or use headers() in server components
