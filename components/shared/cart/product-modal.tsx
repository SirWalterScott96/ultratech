...
const ProductModal = ({
  ...
  return (
    <div
      className={`grid grid-cols-[70px_1fr_120px_100px] items-center gap-4 border-b pb-2 transition-all duration-300 
        ${
          isRemoving
    ...
    >
      ...
      <div className="flex items-center justify-center border rounded-md px-2 w-[120px]">
        <button
      ...
      {/* Total price */}
      <p className="font-bold text-right w-[100px]">
